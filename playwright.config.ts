...
const DATABASE_URL =
	...
	'postgresql://baratie:password@localhost:5433/baratie';
		...
		: [
				{
					...
					// itself; the admin user is seeded on startup.
					...
					env: {
						DATABASE_URL,
						BRT_ADDR: '127.0.0.1:8000',
						CORS_ORIGINS: `${BASE_URL},http://localhost:${PORT},http://127.0.0.1:${PORT}`,
						BRT_JWT_SECRET: JWT_SECRET,
						BRT_ADMIN_USERNAME: ADMIN_USERNAME,
						BRT_ADMIN_PASSWORD: ADMIN_PASSWORD
					}
				},
				{
